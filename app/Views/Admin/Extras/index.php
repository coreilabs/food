...
<div class="row">
  ...
  <h2 class="card-title text-white"><?= esc($titulo) ?></h2>
                ...
                <div class="card-body">
                    ...
                    <div class="ui-widget" >
                      <input id="query" placeholder="Pesquise por um em extra de produto" class="form-control bg-light mb-5">
                    </div>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <?php foreach($extras as $extra):?>
                            ...
                            <tr>
                                <td><a href="<?= site_url("admin/extras/show/$extra->id")?>">  <?= $extra->nome;?></a>
