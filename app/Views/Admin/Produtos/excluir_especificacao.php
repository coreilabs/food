...
<div class="row justify-content-md-center">
  ...
  <h2 class="card-title text-white"><?= esc($titulo) ?></h2>
      ...
      <?php endif;?>
        ...
        <?= form_open("admin/produtos/excluirespecificacao/$especificacao->id/$especificacao->produto_id")?>
...
<button type="submit"  class="btn btn-sm btn-danger btn-icon-text  m-1">
  ...
  <a href="<?= site_url("admin/produtos/especificacoes/$especificacao->produto_id")?>" class="btn btn-primary btn-sm  btn-icon-text  m-1">
