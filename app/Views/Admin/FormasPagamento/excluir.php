...
<div class="row justify-content-md-center">
  ...
  <h2 class="card-title text-white"><?= esc($titulo) ?></h2>
      ...
      <?php endif;?>
        ...
        <?= form_open("admin/formas/excluir/$forma->id")?>

        <div class="alert alert-warning alert-dismissible fade show" role="alert">
  <strong>Atenção: </strong> Tem certeza da exclusão da forma de pagamento <?= esc($forma->nome) ?>?
...
<button type="submit"  class="btn btn-sm btn-danger btn-icon-text  m-1">
  ...
  <a href="<?= site_url("admin/formas/show/$forma->id")?>" class="btn btn-primary btn-sm  btn-icon-text  m-1">
